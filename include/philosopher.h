...
/*   Updated: 2023/07/27 15:09:01 by math             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int64_t				save_msg(char *msg, int32_t msg_len, t_philo *ph,
						t_data *data);
...
void				save_to_buffer(const char *msg, int64_t last_action,
						t_philo *ph, t_data *data);
bool				print_msg_buffer(t_data *data);
void				*init_print_buffer(void);
void	save_to_buffer_at(int64_t last_action,
						t_philo *ph,
						t_data *data,
						int32_t msg_index);

void				eating(t_philo *ph, t_data *data, int64_t time_to_eat,
						int64_t time_to_die);
